...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  echo_time = HCSR04_Read();

	  if(echo_time > 100 && echo_time < 25000)
	  {
	    distancia = echo_time / 40;
	  }
	  else
	  {
	    distancia = 0;
	  ...
	  __HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, pwm_int);
	  // -------------------------------------
